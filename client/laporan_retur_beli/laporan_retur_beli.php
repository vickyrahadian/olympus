 ...
 * FILE     : laporan_retur_beli.php                                                                                *
 * DESC     : Digunakan untuk menampilkan laporan retur pembelian barang                                            *
...
<script type="text/javascript">
    ...
    var title = 'Laporan \u00BB Laporan Retur Pembelian';
    var headerTitle = ['No', 'No Faktur Pembelian', 'No Referensi Retur', 'Tanggal Retur Pembelian', 'Pemasok', 'Total'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
    ...
    function sendReq(inhal, inkode) {
        ...
        $.ajax({
            ...
            cache: false,
            dataType: 'json',
            url: 'client/laporan_retur_beli/get_data_retur_beli.php',
            ...
            if (jumlahData <= 0) {
                ...
                for (i = 0; i < jumlahData; i++) {
                    ...
                    data[i][0] = response.data[i].id_returbeli;
                    ...
                    data[i][5] = response.data[i].id_pembelian;
                    data[i][6] = response.data[i].nofakturpembelian;
                    data[i][7] = response.data[i].idpemasok;
                    data[i][8] = response.data[i].namapemasok;
                    data[i][9] = response.data[i].alamatpemasok;
                    data[i][10] = response.data[i].totalpembelian;
    ...
    <form id="forminputs" method="post" enctype="multipart/form-data">
        ...
        <table id="content_form" style="width: 100%;" border="0">   
            <tr>
                ...
                <td width="40%">
                    <input type="radio" name="rb_filter_pemasok" id="showall" checked="checked" onclick="showAllPemasok()"/>Semua 
                    <input type="radio" name="rb_filter_pemasok" id="showperdate" onclick="showPerPemasok()" />Per Permasok &nbsp;
                    <span id="perpemasok" style="display:none">
