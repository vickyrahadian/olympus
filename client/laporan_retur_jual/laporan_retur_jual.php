 ...
 * FILE     : laporan_retur_jual.php                                                                                *
 * DESC     : Digunakan untuk menampilkan laporan retur penjualan barang                                            *
...
<script type="text/javascript">
    ...
    var title = 'Laporan \u00BB Laporan Retur Penjualan';
    var headerTitle = ['No', 'No Faktur Penjualan', 'No Referensi Retur', 'Tanggal Retur', 'Pelanggan', 'Total'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
    ...
    function sendReq(inhal, inkode) {
        ...
        $.ajax({
            ...
            cache: false,
            dataType: 'json',
            url: 'client/laporan_retur_jual/get_data_retur_jual.php',
    ...
    function showListPelanggan() {
        winRef = openWindow('index.php?page=9d30099200ef101108a7739587fa5c97');
    }
    ...
    function cetakNota() {
        ...
        cetakLaporan('index.php?cetak=3318229a0e7668cecc196eedfc6b3a87', type, startdate, enddate, id);
    }
