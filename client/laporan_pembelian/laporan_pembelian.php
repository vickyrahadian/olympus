 ...
 * FILE     : laporan_pembelian.php                                                                                 *
 * DESC     : Digunakan untuk menampilkan laporan pembelian barang                                                  *
...
<script type="text/javascript">
    ...
    var title = 'Laporan \u00BB Laporan Pembelian';
    var headerTitle = ['No', 'No Referensi', 'No Faktur', 'Tanggal Pembelian', 'Pemasok', 'Total'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
    ...
    function sendReq(inhal, inkode) {
        ...
        $.ajax({
            ...
            cache: false,
            dataType: 'json',
            url: 'client/laporan_pembelian/get_data_pembelian.php',
    ...
    function showListPemasok() {
        winRef = openWindow('index.php?page=4a4875fc8931624b0daeed8ff621e7e9');
    }
    ...
    function cetakNota() {
        ...
        cetakLaporan('index.php?cetak=4f77bfc1b16f286c42dfc6cfa8caf733', type, startdate, enddate, id);
    }
