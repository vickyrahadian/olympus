 ...
 * FILE     : barang_satuan.php                                                                                     *
 * DESC     : Digunakan untuk melakukan CRUD pada master data satuan barang                                         *
...
<script type="text/javascript">
    ...
    var title = 'Master \u00BB Satuan Barang';
    var headerTitle = ['No', 'Nama Satuan'];
    ...
    function sendReq(inhal, inkode) {
        ...
        $.ajax({
            ...
            cache: false,
            dataType: 'json',
            url: 'client/barang_satuan/get_data_barang_satuan.php',
            ...
            if (jumlahData <= 0) {
                ...
                for (i = 0; i < jumlahData; i++) {
                    data[i][0] = response.data[i].id_barangsatuan;
    ...
    function entryValidate() {
        ...
        if (reValue == false) {
            ...
            if (formType == "INS") {
                ...
                clearForm();
                toggleForm('forminput');
                alertify.success('Data satuan barang baru berhasil disimpan <br /> &nbsp;');
            } else if (formType == "UPD") {
                sendReq(1, '2222');
                clearForm();
                toggleForm('forminput');
                alertify.success('Data satuan barang berhasil diubah <br /> &nbsp;');
            }
            kode = 1111;
        }
    }
...
<div id="forminput" style="display: none;">
    <table id="content_form" style="width: 100%;">
        <tr>
            <td style="width: 100;">Nama Satuan</td>
            <td id="tdnama"><input type="text" id="nama" class="text" value="" size="30" onkeyup="if (event.keyCode == 13) {
                        entryValidate();
                    }" /></td>
