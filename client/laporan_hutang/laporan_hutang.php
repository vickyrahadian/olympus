 ...
 * FILE     : laporan_hutang.php                                                                                    *
 * DESC     : Digunakan untuk menampilkan laporan pembayaran hutang                                                 *
...
<script type="text/javascript">
    ...
    var title = 'Laporan \u00BB Laporan Pembayaran Hutang';
    var headerTitle = ['No', 'No Nota Pembayaran', 'Tanggal Pembayaran', 'Pemasok', 'Total'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
    ...
    function sendReq(inhal, inkode) {
        ...
        $.ajax({
            ...
            cache: false,
            dataType: 'json',
            url: 'client/laporan_hutang/get_data_hutang.php',
    ...
    function showListPemasok() {
        winRef = openWindow('index.php?page=f70f32dc3f0862dbfb257c365fe97be4');
    }

    function getDataPemasok(id, nama, alamat, kota) {
        $('#id').val(id);
    ...
    function cetakNota() {
        ...
        printLaporan('index.php?cetak=6d8cfb04d407d520f9da9f5a06d2c46e', type, startdate, enddate, id, 0, 0, 0, 0, 0, 0);
    }
        ...
        <table id="content_form" style="width: 100%;" border="0">   
            <tr>
                ...
                <td width="40%">
                    ...
                    <input type="radio" name="rb_filter_pemasok" id="showpersup" onclick="showPerPemasok()" />Per Pemasok &nbsp;
                    <span id="perpemasok" style="display:none"></span> 
                </td>
            </tr> 
            <tr>
