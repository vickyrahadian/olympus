 ...
 * FILE     : pelanggan.php                                                                                         *
 * DESC     : Digunakan untuk melakukan CRUD pada master data pelanggan                                             *
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#fgambar').on('change', function() {
            $("#forminputs").vPB({
                url: 'client/pelanggan/get_pelanggan_upload_image.php',
    ...
    function gridView(id) {
        ...
        $('#gambarview').html(data[id][6] == '' ? '<img src="asset/images/ina.jpg" height="125px"/>' : ('<br/ ><img width="100px" src="asset/images/pelanggan/' + data[id][6] + '" /><br /><br />'));
    ...
    function showEditForm(id) {
        ...
        if (data[id][6] == '') {
            ...
            $("#spangambar").show().html('<br /><br /><img width="100px" src="asset/images/pelanggan/' + data[id][6] + '" />');
            $("#spangambardelete").show();
        }
    ...
    function entryValidate() {
        ...
        if (reValue == false) {
            ...
            if ((namaTempGambar != '') && (namaTempGambar != namaTempGambar2)) {
                moveFile(namaTempGambar, 'asset/images/temp/', 'asset/images/pelanggan/');
            }
            ...
            if (formType == "INS") {
                ...
                clearForm();
                toggleForm('forminput');
                alertify.success('Data pelanggan baru berhasil disimpan <br /> &nbsp;');
            } else if (formType == "UPD") {
                sendReq(1, '2222');
                clearForm();
                toggleForm('forminput');
                alertify.success('Data pelanggan berhasil diubah <br /> &nbsp;');
            }
            kode = 1111;
        }
    }
