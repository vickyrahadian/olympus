...
<script type="text/javascript">
    ...
    function fillTable(data) {
        ...
        for (j = 0; j < data[0][98]; j++) {
            reValueTable += '<tr onClick="closeWindow(' + data[j][0] + ', \'' + data[j][1] + '\'' + ', \'' + data[j][3] + ', ' + data[j][4] + ' ' + data[j][7] + '\')" >';
    ...
    function closeWindow(id, nama, alamat) {
        opener.getDataPemasok(id, nama, alamat);
        window.close();
    }
