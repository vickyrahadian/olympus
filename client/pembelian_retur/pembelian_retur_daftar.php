 ...
 * FILE     : pembelian_retur_daftar.php                                                                            *
 * DESC     : Digunakan untuk melihat daftar retur pembelian                                                        *
...
<script type="text/javascript">
    ...
    var title = 'Transaksi \u00BB Daftar Retur Pembelian';
    var headerTitle = ['No', 'No Referensi', 'No Faktur Pembelian', 'Tanggal Retur', 'Pemasok', 'Total Retur'];
    ...
    function sendReq2(inhal, inkode, id) {
        ...
        $.ajax({
            ...
            for (i = 0; i < jumlahData; i++) {
                data2[i][0] = response.data[i].id_returbelidetail;
                data2[i][1] = response.data[i].id_returbeli;
    ...
    function cetakNota() {
        cetak('index.php?cetak=72224b44309ffc2fc381c64295d64e92', $('#id').val());
    }
