 ...
 * FILE     : pembelian_daftar.php                                                                                  *
 * DESC     : Digunakan untuk melihat daftar pembelian                                                              *
...
<script type="text/javascript">
    ...
    var title = 'Transaksi \u00BB Daftar Pembelian';
    ...
    function sendReq2(inhal, inkode, id) {
        ...
        $.ajax({
            ...
            for (i = 0; i < jumlahData; i++) {
                data2[i][0] = response.data[i].id_pembeliandetail;
    ...
    function cetakNota() {
        cetak('index.php?cetak=1e04a1720c57aaa75b1d45eae45dfda8', $('#id').val());
    }
...
| 
<a href="?page=fbaba39b277f18b03918ded3bf1a747d" class="tambah">Tambah</a>