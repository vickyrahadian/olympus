...
<script type="text/javascript">
    ...
    var headerTitle = ['Barcode', 'Kode Barang', 'Nama Barang', 'Harga Ecer'];
    ...
    function fillTable(data) {
        ...
        for (j = 0; j < data[0][98]; j++) {
            reValueTable += '<tr onClick="closeWindow(' + data[j][0] + ', \'' + data[j][12] + '\', \'' + data[j][2] + '\', \'' + data[j][4] + '\')" >';
    ...
    function closeWindow(id, kode, nama, harga) {
        opener.getDataBarang(id, kode, nama, harga);
        window.close();
    }
</script>
