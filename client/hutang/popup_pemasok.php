 ...
 * DESC     : Digunakan untuk memilih data pemasok untuk pembayaran hutang                                          *
...
<script type="text/javascript">
    ...
    var headerTitle = ['No', 'Nama Pemasok', 'Sisa Hutang'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
    ...
    function fillTable(data) {
        ...
        for (j = 0; j < data[0][98]; j++) {
            ...
            if (data[j][4] - data[j][5] - data[j][6] - data[j][7] < 0) {
                ...
                reValueTable += '<td align="right" width="150">' + toRp(data[j][4] - data[j][5] - data[j][6] - data[j][7]) + '</td>';
            }
            reValueTable += '</td></tr>';
            i++;
        }
