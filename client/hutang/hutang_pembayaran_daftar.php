 ...
 * FILE     : hutang_pembayaran_daftar.php                                                                          *
 * DESC     : Digunakan untuk melihat daftar pembayaran hutang kepada pemasok                                       *
...
<script type="text/javascript">
    ...
    var title = 'Transaksi \u00BB Daftar Pembayaran Hutang';
    var headerTitle = ['No', 'No Referensi', 'Tanggal Pembayaran', 'Nama Pemasok', 'Total'];
    var headerTitle2 = ['No', 'No Referensi Pembelian', 'Total Pembelian', 'Total Bayar'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
    ...
    function sendReq2(inhal, inkode, id) {
        ...
        $.ajax({
            ...
            for (i = 0; i < jumlahData; i++) {
                ...
                data2[i][0] = response.data[i].id_hutangdetail;
                data2[i][1] = response.data[i].id_hutang;
                data2[i][2] = response.data[i].id_pembelian;
                data2[i][3] = response.data[i].total;
                data2[i][4] = response.data[i].no_nota;
                data2[i][5] = response.data[i].totalpembelian;
    ...
    function cetakNota() {
        cetak('index.php?cetak=29b63e558b09ce6d0898459ea5ed9b27', $('#id').val());
    }
...
<div id="forminput" style="display: none;">
    ...
    <table style="width:100%;"id="content_table2">
        ...
        <tr>
            <td style="width:80px;">Pemasok</td> 
