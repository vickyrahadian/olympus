 ...
 * FILE     : bukubesar.php                                                                                         *
 * DESC     : Digunakan untuk melihat buku besar pada aplikasi                                                      *
...
<script type="text/javascript">
    ...
    var title = 'Accounting \u00BB Buku Besar';
    var headerTitle = ['No', 'Tanggal', 'Debit', 'Kredit'];
    ...
    function sendReq(inhal, inkode) { 
        ...
        datasend[0][1] = USERID;
        datasend[0][2] = $('#id').val();
        datasend[0][3] = $('#kodeakun').val();
        if ($('#showall').is(':checked')) {
            datasend[0][4] = 1;
        } else {
            datasend[0][4] = 2;
        } 
        datasend[0][5] = convertDateToDatabse($('#tanggal_mulai').val());
        datasend[0][6] = convertDateToDatabse($('#tanggal_akhir').val());
        datasend[0][97] = kode;
        datasend[0][98] = inhal;
        datasend[0][99] = limit;
        ...
        $.ajax({
            ...
            cache: false,
            dataType: 'json',
            url: 'client/accounting_bukubesar/get_data_bukubesar.php',
            ...
            if (jumlahData <= 0) {
                ...
                for (i = 0; i < jumlahData; i++) {
                    ...
                    data[i][6] = response.data[i].kode_rekening;
                    data[i][7] = response.data[i].nama_rekening; 
                    data[i][8] = response.data[i].sumdebit; 
                    data[i][9] = response.data[i].sumkredit; 
    ...
    function fillTable(data) {
        ...
        reValueTable += '<tr><td align="right" colspan="2"><strong>Total</strong></td><td align="right"><strong>' + toRp(data[0][8]) + '</strong></td><td align="right"><strong>' + toRp(data[0][9]) + '</strong></td></tr>';
        return reValueTable
    }
    ...
    function getDropDownKodeAkun(idselect, name, url, inkode) {
        ...
        $.ajax({
            ...
            if (jumlahData <= 0) {
                ...
                for (i = 0; i < jumlahData; i++) {
                    reValue += "<option value='" + response.data[i].id_kodeakun + "'>" + response.data[i].nama_akun + "</option>";
                }
            }
            reValue += "</select>";
    ...
    function cetakNota() {
        ...
        printLaporan('index.php?cetak=682f8c5261ae5a53cbdf433d9b289fbe', idAkun, type, startdate, enddate, 0, 0, 0, 0, 0, 0);
    }
    ///////////////////////////////////////////////////////
    // PART F - END////////////////////////////////////////
    ///////////////////////////////////////////////////////
...
<div id="forminput" style="display: ">
    <table id="content_form" style="width: 100%;">
        <tr>
            <td style="width: 100;">Nama Akun</td>
            <td id="tdkodeakun">
                <script type="text/javascript">getDropDownKodeAkun('tdkodeakun', 'kodeakun', 'client/accounting_bukubesar/get_data_kodeakun.php', '1114')</script>
            </td>
            <td id="kodeakunview" style="display: none;"></td>
            <td style="width: 500;">
        ...
        <tr>
            <td colspan="3" align="center" style="padding:15px;">
                ...
                <span class='tombol' id="bsimpan" onclick="searchSimple();">TAMPILKAN</span> 
