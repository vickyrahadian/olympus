 ...
 * FILE     : popup_penjualan.php                                                                                   *
 * DESC     : Digunakan untuk memilih data penjualan barang untuk retur                                             *
...
<script type="text/javascript">
    ...
    var headerTitle = ['No', 'No Faktur', 'Tanggal', 'Pelanggan', 'Total'];
    var kode;
    var hal = 0;
    var totalHalaman;
    var limit = 10;
